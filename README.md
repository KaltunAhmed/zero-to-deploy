...
2. [What a server is](docs/01-foundations/02-what-is-a-server.md)
3. [Run your first local server](docs/01-foundations/03-run-your-first-server.md)

### Part 2 — Version Control
4. What Git is vs what GitHub is
5. Repositories — what they actually contain
6. Branches — why we don't all edit `main` directly
7. Commits, pushing, and pulling
8. Pull Requests — proposing and reviewing changes
9. Merging and merge conflicts

### Part 3 — Testing & CI
10. Why we test code (and what breaks without it)
...
16. What an environment is (isolated infrastructure, not just a label)
17. Dev, staging, and prod — purpose of each
18. Other environments you may see (ext test / sandbox / UAT)
19. What manual deployment used to look like (and why it was risky)
20. What CD is — automating deployment

### Part 5 — Containers
21. The problem containers solve ("works on my machine")
22. What a container actually is
...
35. The problem with manually clicking around AWS
...
44. Troubleshooting / common beginner mistakes